#
#  Be sure to run `pod spec lint ScwToolwork.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.version      = "1.0"
  spec.summary      = "A short description of ScwToolwork."
  ...
  # Or just: spec.author    = "scw"
  # spec.authors            = { "scw" => "1016733717@qq.com" }
  # spec.social_media_url   = "https://twitter.com/scw"
